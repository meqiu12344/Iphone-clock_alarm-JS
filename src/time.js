    ...
    if (document.cookie.length>2) {
        ...
        for (i=0;i<pary.length;i++) {
            ...
            if (dane[0]==nazwa) {
                ...
                element.innerHTML="<div class='flex'><div class='w-50'><h1>"+ czas[0] +":"+ czas[1]+"</h1><span'>Cały tydzień</span></div>"+
                " <div class='w-50'><label class='toggler-wrapper style-1'><input type='checkbox' id='b"+i+"'><div class='toggler-slider'><div class='toggler-knob'></div></div></label></div></div>";
